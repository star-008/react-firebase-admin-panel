...
class PackageAdd extends React.Component {
  ...
  loadData() {
    ...
    Firebase.firestore().collection('Packages').get().then(function (res) {
        var next_id = "1000001";
        if (res.docs.length > 0) {
            var last_id = res.docs[res.docs.length - 1].id;
            next_id = (parseInt(last_id) + 1).toString();
        }
        _this.setState({code: next_id});
        ...
        if (file !== null) {
            ...
            customerRef.put(file).then(function (snapshot) {
                customerRef.getDownloadURL().then(function (res) {
                    ...
                    Firebase.firestore().collection('Packages').doc(_this.state.code).set(add_data).then(function () {
                        _this.notifyMessage("tc", 2, "Add package success!");
                        _this.setState({loading: false});
          ...
          >
              ...
              <Row>
                  <Col md="12">
                      <Card>
                          <CardHeader>
                              <CardTitle tag="h4">Package Add</CardTitle>
                          </CardHeader>
                          <CardBody>
                              <div className="row">
                                          ...
                                          <div className="col-md-12">
                                              ...
                                              <Row>
                                                  ...
                                                  <Col md="3">
                                                      <FormGroup>
                                                          <Input
                                                              defaultValue={this.state.multi_location}
                                                              type="number"
                                                              min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.numbers_counters}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.numbers_services}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.numbers_token_service}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.user_no}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.monthly_price}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.annual_price}
                                                                  type="number"
                                                                  min={0}
                                                      ...
                                                      <Col md="4">
                                                          <FormGroup>
                                                              <Input
                                                                  ...
                                                                  defaultValue={this.state.trail_days}
                                                                  type="number"
                                                                  min={0}
                                              ...
                                              <Form className="form-horizontal">
                                                  <Row>
                                                      ...
                                                      <Col md="3">
                                                          <FormGroup>
                                                              <Input
                                                                  defaultValue={this.state.order_sequence}
                                                                  type="number"
                                                                  min={0}
