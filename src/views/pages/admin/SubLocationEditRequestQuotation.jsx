...
class SubLocationEditRequestQuotation extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <Row>
                        <Col md="12">
                            <Card className="full-size">
                                <CardHeader>
                                    <CardTitle tag="h4">SubLocation Edit / Request for Quotation</CardTitle>
                                </CardHeader>
                                <CardBody>
...
export default SubLocationEditRequestQuotation;
